...
//SSS prefixed several CommonC++ elements with ost::
...
static ost::Mutex s_PortalArrayLock;                         // protects g_PortalArrayIndex, s_PortalArray
...
INT basePacket::getPacketSizeByType(INT type) {
  switch ((PACKETtypes) type) {
    case VIS_PACKET_LOGIN:return sizeof(VIS_LOGIN);
    case VIS_PACKET_LOGIN_NAK:return sizeof(VIS_LOGIN_NAK);
    case VIS_PACKET_LOGIN_ACK:return sizeof(VIS_LOGIN_ACK);

    case VIS_PACKET_WANT_BSP_DATA:return sizeof(VIS_WANT_BSP_DATA);
    case VIS_PACKET_BSP_DATA_NAK:return sizeof(VIS_BSP_DATA_NAK);
    case VIS_PACKET_BSP_DATA:return VARIABLE_LENGTH_PACKET;
    case VIS_PACKET_BSP_NAME:return sizeof(VIS_BSP_NAME);

    case VIS_PACKET_WANT_PRT_DATA:return sizeof(VIS_WANT_PRT_DATA);
    case VIS_PACKET_PRT_DATA_NAK:return sizeof(VIS_PRT_DATA_NAK);
    case VIS_PACKET_PRT_DATA:return VARIABLE_LENGTH_PACKET;

    case VIS_PACKET_WANT_MIGHTSEE_DATA:return sizeof(VIS_WANT_MIGHTSEE_DATA);
    case VIS_PACKET_MIGHTSEE_DATA_NAK:return sizeof(VIS_MIGHTSEE_DATA_NAK);
    case VIS_PACKET_MIGHTSEE_DATA:return VARIABLE_LENGTH_PACKET;

    case VIS_PACKET_LEAFTHREAD:return sizeof(VIS_LEAFTHREAD);
    case VIS_PACKET_LEAFTHREAD_ACK:return sizeof(VIS_LEAFTHREAD_ACK);
    case VIS_PACKET_LEAFTHREAD_NAK:return sizeof(VIS_LEAFTHREAD_NAK);

    case VIS_PACKET_WANT_FULL_SYNC:return sizeof(WANT_FULL_SYNC);
    ...
    case VIS_PACKET_SYNC_PORTAL:return myoffsetof(VIS_SYNC_PORTAL, data) + g_bitbytes;
    case VIS_PACKET_SYNC_PORTAL_CLUSTER:return VARIABLE_LENGTH_PACKET;

    case VIS_PACKET_GOING_DOWN:return sizeof(GOING_DOWN);
...
void basePacket::HandleIncomingPacket(basePacket *packet, NetvisSession *socket) {
  switch (packet->getType()) {
    case VIS_PACKET_LOGIN:Handle_VIS_LOGIN((VIS_LOGIN *) packet, socket);
      break;
    case VIS_PACKET_LOGIN_NAK:Handle_VIS_LOGIN_NAK((VIS_LOGIN_NAK *) packet, socket);
      break;
    case VIS_PACKET_LOGIN_ACK:Handle_VIS_LOGIN_ACK((VIS_LOGIN_ACK *) packet, socket);
      break;

    case VIS_PACKET_WANT_BSP_DATA:Handle_VIS_WANT_BSP_DATA((VIS_WANT_BSP_DATA *) packet, socket);
      break;
    case VIS_PACKET_BSP_DATA_NAK:Handle_VIS_BSP_DATA_NAK((VIS_BSP_DATA_NAK *) packet, socket);
      break;
    case VIS_PACKET_BSP_DATA:Handle_VIS_BSP_DATA((VIS_BSP_DATA *) packet, socket);
      break;
    case VIS_PACKET_BSP_NAME:Handle_VIS_BSP_NAME((VIS_BSP_NAME *) packet, socket);
      break;

    case VIS_PACKET_WANT_PRT_DATA:Handle_VIS_WANT_PRT_DATA((VIS_WANT_PRT_DATA *) packet, socket);
      break;
    case VIS_PACKET_PRT_DATA_NAK:Handle_VIS_PRT_DATA_NAK((VIS_PRT_DATA_NAK *) packet, socket);
      break;
    case VIS_PACKET_PRT_DATA:Handle_VIS_PRT_DATA((VIS_PRT_DATA *) packet, socket);
      break;

    case VIS_PACKET_WANT_MIGHTSEE_DATA:Handle_VIS_WANT_MIGHTSEE_DATA((VIS_WANT_MIGHTSEE_DATA *) packet, socket);
      break;
    case VIS_PACKET_MIGHTSEE_DATA_NAK:Handle_VIS_MIGHTSEE_DATA_NAK((VIS_MIGHTSEE_DATA_NAK *) packet, socket);
      break;
    case VIS_PACKET_MIGHTSEE_DATA:Handle_VIS_MIGHTSEE_DATA((VIS_MIGHTSEE_DATA *) packet, socket);
      break;

    case VIS_PACKET_LEAFTHREAD:Handle_VIS_LEAFTHREAD((VIS_LEAFTHREAD *) packet, socket);
      break;
    case VIS_PACKET_LEAFTHREAD_ACK:Handle_VIS_LEAFTHREAD_ACK((VIS_LEAFTHREAD_ACK *) packet, socket);
      break;
    case VIS_PACKET_LEAFTHREAD_NAK:Handle_VIS_LEAFTHREAD_NAK((VIS_LEAFTHREAD_NAK *) packet, socket);
      break;

    case VIS_PACKET_WANT_FULL_SYNC:Handle_VIS_WANT_FULL_SYNC((WANT_FULL_SYNC *) packet, socket);
      break;
    case VIS_PACKET_DONE_PORTAL:Handle_VIS_DONE_PORTAL((VIS_DONE_PORTAL *) packet, socket);
      break;
    case VIS_PACKET_SYNC_PORTAL_CLUSTER:Handle_VIS_SYNC_PORTAL_CLUSTER((VIS_SYNC_PORTAL_CLUSTER *) packet, socket);
      break;

    case VIS_PACKET_GOING_DOWN:Handle_VIS_GOING_DOWN((GOING_DOWN *) packet, socket);
      break;
  }
}
...
static ost::Mutex s_ClientWorkQueueLock;                     // protects s_ClientWorkQueue
