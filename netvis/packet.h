...
class VIS_DONE_PORTAL : public varPacket {    // ATTN: This is a variable-length packet.  Changing this structure requires fixing up the ::Send code, as well as the getPacketSizeByType method)
 protected: // data
  INT32 portalindex;
  INT32 numcansee;
 public:
...
class VIS_SYNC_PORTAL : public varPacket {    // ATTN: This is a variable-length packet.  Changing this structure requires fixing up the ::Send code, as well as the getPacketSizeByType method)
 protected: // data
  INT32 portalindex;
  INT32 numcansee;
...
class VIS_SYNC_PORTAL_CLUSTER : public varPacket {    // ATTN: This is a variable-length packet.  Changing this structure requires fixing up the ::Send code, as well as the getPacketSizeByType method)
 protected: // data
...
class VIS_MIGHTSEE_DATA : public varPacket {    // ATTN: This is a variable-length packet.  Changing this structure requires fixing up the ::Send code, as well as the getPacketSizeByType method)
 protected: // data
  INT32 portalindex;
  INT32 nummightsee;
 public:
