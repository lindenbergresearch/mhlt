...
// Common descriptions
//#define internallimit   "The compiler tool hit an internal limit"
//#define internalerror   "The compiler tool had an internal error"
//#define maperror        "The map has a problem which must be fixed"
...
//#define selfexplanitory "self explanitory"
//#define reference "Check the file ZHLTProblems.html for a detailed explanation of this problem"
//#define simplify "The map is too complex for the game engine/compile tools to handle.  Simplify"
//#define contactmerl "contact merlinis@bigpond.net.au concerning this issue."
const char *const selfexplanitory = "self explanitory";
const char *const reference = "Check the file ZHLTProblems.html for a detailed explanation of this problem";
const char *const simplify = "The map is too complex for the game engine/compile tools to handle.  Simplify";
const char *const contactmerl = "contact merlinis@bigpond.net.au concerning this issue.";
