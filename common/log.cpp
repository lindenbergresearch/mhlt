...
// =====================================================================================
void Banner() {
  Log("Zoner's Half-Life Compilation Tools for macOS\n");
  Log("%s " ZHLT_VERSIONSTRING " " HACK_VERSIONSTRING " (compiled on: %s %s)\n\n", g_Program, __DATE__, __TIME__);
  Log("Based on code modifications by Sean 'Zoner' Cavanaugh.\n");
  Log("Based on Valve's version, modified with permission.\n");
  Log("Modified to compile on modern macOS ARM64/X86_64 by Lindenberg Research." MODIFICATIONS_STRING "\n\n");
  Log("--- Experimental build - use at your own risk. ---\n\n");
}
