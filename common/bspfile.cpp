...
int g_lightdatasize;
byte g_dlightdata[MAX_MAP_LIGHTING];
...
void PrintBSPFileSizes() {
  ...
  totalmemory += GlobUsage("lightdata", g_lightdatasize, sizeof(g_dlightdata));
